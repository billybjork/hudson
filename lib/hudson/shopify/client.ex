defmodule Hudson.Shopify.Client do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Hudson.Shopify.Client.fetch_products()
      {:ok, %{products: [...], has_next_page: true, end_cursor: "..."}}

      iex> Hudson.Shopify.Client.fetch_products("cursor_string")
  ...
  defp build_headers do
    token = Application.fetch_env!(:hudson, :shopify_access_token)
  ...
  defp graphql_url do
    store_name = Application.fetch_env!(:hudson, :shopify_store_name)
